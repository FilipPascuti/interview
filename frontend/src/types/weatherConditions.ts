export enum WeatherCondition {
    ...
    CLEAR = 'Clear',
    PARTLY_CLOUDY_ALT = 'Partly Cloudy',
    ...
    THUNDERY_OUTBREAKS_NEARBY = 'Thundery outbreaks in nearby',
    PATCHY_LIGHT_RAIN_WITH_THUNDER_ALT = 'Patchy light rain in area with thunder',
    MODERATE_OR_HEAVY_RAIN_WITH_THUNDER_ALT = 'Moderate or heavy rain in area with thunder',
    PATCHY_LIGHT_SNOW_WITH_THUNDER_ALT = 'Patchy light snow in area with thunder',
    MODERATE_OR_HEAVY_SNOW_WITH_THUNDER_ALT = 'Moderate or heavy snow in area with thunder',
}

export type WeatherConditionValue = (typeof WeatherCondition)[keyof typeof WeatherCondition];
